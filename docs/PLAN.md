...
| R20 | `kaya auth login/logout/status` (RFC 8628 device flow) + a hosted remote MCP endpoint (ADR 0013) | **`kaya auth login/logout/check` shipped (`KAN-1743`); hosted MCP shipped (`KAN-1744`, ADR 0014)** — see `docs/roadmap/BREADBOARD.md`'s R20 section. Its docs pass (`KAN-1745`) not started. |
