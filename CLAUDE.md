...
way in, KAN-556 the conflict banner, KAN-554 the sidebar and the preview and KAN-767 the chunk split, so `frontend/` is a
...
editor's ~80 kB gzip onto **its own chunk**, so the visitor who has not signed in yet no longer downloads
one. After V3,
